...
export interface ApiBuyBuy extends Schema.CollectionType {
  ...
  attributes: {
    ...
    CVC: Attribute.String;
    NameOnCard: Attribute.String;
    checkout: Attribute.Component<'layout.button'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiGameGame extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Buyers: Attribute.Relation<'api::game.game', 'oneToMany', 'admin::user'>;
    ...
    Game: Attribute.Component<'seo.seo-information'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    types: Attribute.Relation<'api::game.game', 'manyToMany', 'api::type.type'>;
...
export interface ApiHomePageHomePage extends Schema.SingleType {
  ...
  attributes: {
    ...
    GamesSelection: Attribute.DynamicZone<
      ['games.featured-games', 'games.game-selection']
    > &
      Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiTypeType extends Schema.CollectionType {
  ...
  attributes: {
    ...
    games: Attribute.Relation<'api::type.type', 'manyToMany', 'api::game.game'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
